...
def get_movie():
    ...
    """
    id = {}
    with open("/home/czt/PycharmProjects/untitled1/2010.txt", "r")as f:
        fp = f.readlines()
        for line in fp:
...
def get_company(urls, movie_name,id):
    ...
    try:
        ...
        flag -= 1
        with open('./movie_failed.txt',"a+")as w:
            w.writelines("Fail in I_company" + movie_name + id)
            w.write('\n')
    #print(flag)
...
def mongoDB_insert(id,movie_name,s):
    ...
    :return: void
    """
    db.col.insert({'_id': id, 'year': "2010",
